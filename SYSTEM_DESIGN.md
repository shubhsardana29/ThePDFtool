...
A self-hostable iLovePDF-style web application: 41 PDF tools behind one
...
|---|---|
| Privacy first | Everything that *can* run in the browser does. 30 of 41 tools never upload anything. |
...
Ten tools (edit, sign, organize, compare, visual compare, redact, fill forms, crop, edit
...
~5–60 s, everything else seconds. That serves a lot of traffic given 30 of
41 tools consume zero server resources.
