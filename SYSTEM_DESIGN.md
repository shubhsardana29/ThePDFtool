...
A self-hostable iLovePDF-style web application: 44 PDF tools behind one
...
|---|---|
| Privacy first | Everything that *can* run in the browser does. 33 of 44 tools never upload anything. |
...
Thirteen tools (edit, sign, organize, compare, visual compare, annotate, pipeline, batch, redact, fill forms, crop, edit
...
~5–60 s, everything else seconds. That serves a lot of traffic given 33 of
44 tools consume zero server resources.
